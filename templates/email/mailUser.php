                                        ...
                                        <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left' bgcolor='#ffffff'>
                                            ...
                                            <tbody>
                                                ...
                                                <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                    ...
                                                    <p class='' style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left'>Estimado/a: <strong>$name</strong></p>
                                                    ...
                                                    <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Es un placer para m&#237; compartirle la informacion completa de nuestros cursos y diplomados.</p>
                                                    <br>
                                                    ...
                                                    <p class='text-gray-700 text-center' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='center'>Lic. Justino Salcedo Sanabia</p>
                                                    </div>
                                                </td>
                                                </tr>
                                            </tbody>
