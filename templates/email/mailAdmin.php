                                      ...
                                      <tbody>
                                        <tr>
                                          <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td class='col-12' style='line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 100%; margin: 0;' align='left' valign='top'>
                                                      <center>
                                                        <img class='img-fluid' src='https://practicaforenseenderecho.com/images/logoEmail.png' style='height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; width: 100%; border-style: none; border-width: 0;' width='100%'>
                                                      </center>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                            ...
                                            <p class='' style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left'>Lic. Justino Salcedo</p>
                                            ...
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Una persona se registro en la plataforma, le comparto los datos para que se ponga en contacto con el a la brevedad.</p>
                                            <ul>
                                              <li class='text-gray-700' style='color: #4a5568;'>Nombre: <strong>$name</strong>
                                              </li>
                                              <li class='text-gray-700' style='color: #4a5568;'>Telefono: <strong>$phone</strong>
                                              </li>
                                              <li class='text-gray-700' style='color: #4a5568;'>Email: <strong>$email</strong>
                                              </li>
                                            </ul>
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Contactelo ahora mismo. &#201;xito con su cierre de venta.</p>
                                            <br>
                                            <div class='text-center' style='' align='center'>
                                              <a href='tel:+$phone' style='color: #0d6efd;'><button>Llamar ahora</button></a>
                                              <a href='https://wa.me/$phone' style='color: #0d6efd;'><button>Enviar Mensaje</button></a>
                                            </div>
                                            <table class='s-5 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                              <tbody>
                                                <tr>
